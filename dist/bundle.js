...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: 'setRawDataset',
    value: function setRawDataset(newRawDataset) {
      this.setState({
    ...
    value: function render() {
      return React.createElement(
        'div',
        null,
        React.createElement(_Data2.default, {
...
var DataInput = function (_React$Component) {
  ...
  _createClass(DataInput, [{
    ...
    key: 'renderHead',
    value: function renderHead(columns) {
    ...
    value: function renderDimensions() {
      if (typeof this.props.dataset.columns !== 'undefined') {
        return React.createElement(
          'ul',
          null,
          this.props.dataset.columns.map(function (column, i) {
            return React.createElement(
              'li',
              { key: i + 'li' },
              column,
